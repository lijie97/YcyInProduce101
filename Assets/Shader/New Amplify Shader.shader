...
Shader "Score Bar"
{
	...
	SubShader
	{
		...
		{
			float4 color14 = IsGammaSpace() ? float4(0.2205882,0.5162272,1,0) : float4(0.03988593,0.2293693,1,0);
			o.Albedo = color14.rgb;
			float2 panner3 = ( 1.0 * _Time.y * _Speed + i.uv_texcoord);
			float4 color9 = IsGammaSpace() ? float4(0.5682556,0.2720588,1,0) : float4(0.2827437,0.06015839,1,0);
			float4 color10 = IsGammaSpace() ? float4(0.2573529,0.8770791,1,0) : float4(0.05386956,0.7428153,1,0);
			...
			float4 lerpResult11 = lerp( color9 , color10 , clampResult12);
...
/*ASEBEGIN
Version=16400
-80;329;1246;665;1331.728;836.8916;1.960459;True;False
...
Node;AmplifyShaderEditor.Vector2Node;5;-672.3555,172.6146;Float;False;Property;_Speed;Speed;2;0;Create;True;0;0;False;0;0,1;0,0.6;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;10;-456.2715,622.4149;Float;False;Constant;_Color1;Color 1;2;0;Create;True;0;0;False;0;0.2573529,0.8770791,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;9;-464.3515,439.6053;Float;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;False;0;0.5682556,0.2720588,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;14;23.85833,-706.0973;Float;False;Constant;_Color2;Color 2;2;0;Create;True;0;0;False;0;0.2205882,0.5162272,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B8582DA5826D0F4BD4A2427528AF2FFB03E95617